...
describe('schedulesService', () => {
  ...
  describe('createSchedule', () => {
    it('should create schedule with clinic and time slots', async () => {
      ...
      prismaMock.schedule.create.mockResolvedValue(scheduleWithRelations as any)
  ...
  describe('getScheduleById', () => {
    it('should get schedule by id with relations', async () => {
      ...
      prismaMock.schedule.findUnique.mockResolvedValue(scheduleWithRelations as any)
  ...
  describe('getScheduleByIdAndDoctor', () => {
    it('should get schedule for specific doctor', async () => {
      ...
      const result = await schedulesService.getScheduleByIdAndDoctor('schedule-123', 'doctor-123')
  ...
  describe('updateSchedule', () => {
    it('should update schedule', async () => {
      ...
      const result = await schedulesService.updateSchedule('schedule-123', updateData)
  ...
  describe('getScheduleForDeletion', () => {
    it('should get schedule with booked time slots count', async () => {
      ...
      const result = await schedulesService.getScheduleForDeletion('schedule-123', 'doctor-123')
  ...
  describe('getSchedulesByIds', () => {
    it('should get schedules by ids', async () => {
      ...
      const result = await schedulesService.getSchedulesByIds(['schedule-123'], false)
  ...
  describe('getScheduleForTimeSlots', () => {
    it('should get active schedule with available time slots', async () => {
      ...
      prismaMock.schedule.findUnique.mockResolvedValue(scheduleWithSlots as any)
  ...
  describe('getTimeSlotForToggle', () => {
    it('should get unbooked time slot for doctor', async () => {
      ...
      const result = await schedulesService.getTimeSlotForToggle('slot-123', 'doctor-123')
  ...
  describe('updateTimeSlotBlock', () => {
    it('should update time slot block status', async () => {
      ...
      const result = await schedulesService.updateTimeSlotBlock('slot-123', true)
