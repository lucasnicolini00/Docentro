...
import { mockDoctor, mockSpeciality, mockExperience, mockImage } from '../utils/mocks'
...
describe('doctorsService', () => {
  ...
  describe('getDoctorIdFromUserId', () => {
    it('should return doctor id for valid user id', async () => {
      prismaMock.doctor.findUnique.mockResolvedValue({ id: 'doctor-123' } as any)
    ...
    it('should throw error if doctor not found', async () => {
      ...
      await expect(doctorsService.getDoctorIdFromUserId('invalid-user')).rejects.toThrow('Doctor not found')
    })
  })
  ...
  describe('updateDoctorProfile', () => {
    it('should update doctor profile in transaction', async () => {
      ...
      await doctorsService.updateDoctorProfile('user-123', 'doctor-123', updateData)
  ...
  describe('updateProfileExperience', () => {
    it('should update profile experience description', async () => {
      ...
      const result = await doctorsService.updateProfileExperience('exp-123', 'Updated description')
  ...
  describe('createProfileExperience', () => {
    it('should create new profile experience', async () => {
      ...
      const result = await doctorsService.createProfileExperience('doctor-123', 'Bio description')
