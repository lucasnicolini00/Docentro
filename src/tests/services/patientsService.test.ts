...
describe('patientsService', () => {
  ...
  describe('updatePatientProfile', () => {
    it('should update patient profile in transaction', async () => {
      ...
      const result = await patientsService.updatePatientProfile('user-123', 'patient-123', updateData)
    ...
    it('should handle null optional fields', async () => {
      ...
      await patientsService.updatePatientProfile('user-123', 'patient-123', updateData)
