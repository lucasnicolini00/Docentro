...
describe("appointments actions", () => {
  ...
  describe("createAppointmentAction", () => {
    it("should create appointment successfully", async () => {
      ...
      vi.mocked(
        appointmentsService.createAppointmentWithTimeSlot
  ...
  describe("getUserAppointments", () => {
    it("should get patient appointments", async () => {
      ...
      vi.mocked(appointmentsService.getPatient).mockResolvedValue(
        mockPatient as any
      );
    ...
    it("should get doctor appointments", async () => {
      ...
      vi.mocked(appointmentsService.getDoctor).mockResolvedValue(
        mockDoctor as any
      );
  ...
  describe("getDoctorAppointments", () => {
    it("should get doctor appointments for calendar", async () => {
      vi.mocked(
        appointmentsService.getDoctorAppointmentsForCalendar
      ).mockResolvedValue([mockAppointment] as any);
  ...
  describe("createAppointment", () => {
    it("should create appointment successfully", async () => {
      ...
      vi.mocked(
        appointmentsService.checkConflictingAppointment
      ).mockResolvedValue(null);
      vi.mocked(appointmentsService.createAppointment).mockResolvedValue(
  ...
  describe("getDoctorAvailability", () => {
    it("should return available slots", async () => {
      vi.mocked(
        appointmentsService.getDoctorAppointmentsForAvailability
      ).mockResolvedValue([]);
  ...
  describe("getDoctorClinicsAndPricing", () => {
    it("should get doctor with clinics and pricing", async () => {
      ...
      vi.mocked(appointmentsService.getDoctorWithRelations).mockResolvedValue(
  ...
  describe("updateAppointmentStatus", () => {
    it("should update appointment status", async () => {
      ...
      vi.mocked(
        appointmentsService.getAppointmentForStatusUpdate
      ).mockResolvedValue(mockAppointment as any);
  ...
  describe("cancelAppointment", () => {
    it("should cancel appointment as patient", async () => {
      ...
      vi.mocked(
        appointmentsService.getAppointmentForCancellation
      ).mockResolvedValue({
        ...mockAppointment,
