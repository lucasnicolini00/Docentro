...
describe("search actions", () => {
  ...
  describe("getAllSpecialities", () => {
    it("should return success with specialities data", async () => {
      ...
      vi.mocked(searchService.getAllSpecialities).mockResolvedValue(
        specialities as any
      );
    ...
    it("should return error on failure", async () => {
      vi.mocked(searchService.getAllSpecialities).mockRejectedValue(
        new Error("DB Error")
      );
  ...
  describe("getAllCities", () => {
    ...
    it("should return error on failure", async () => {
      vi.mocked(searchService.getAllCities).mockRejectedValue(
        new Error("DB Error")
      );
  ...
  describe("getPopularSpecialities", () => {
    it("should return success with popular specialities", async () => {
      const specialities = [mockSpeciality];
      vi.mocked(searchService.getPopularSpecialities).mockResolvedValue(
        specialities as any
      );
    ...
    it("should return error on failure", async () => {
      vi.mocked(searchService.getPopularSpecialities).mockRejectedValue(
        new Error("DB Error")
      );
  ...
  describe("getFeaturedDoctors", () => {
    it("should return success with featured doctors", async () => {
      ...
      vi.mocked(searchService.getFeaturedDoctors).mockResolvedValue(
        doctors as any
      );
    ...
    it("should return error on failure", async () => {
      vi.mocked(searchService.getFeaturedDoctors).mockRejectedValue(
        new Error("DB Error")
      );
  ...
  describe("searchDoctors", () => {
    it("should search doctors with default pagination", async () => {
      ...
      vi.mocked(searchService.searchDoctors).mockResolvedValue(
        searchResult as any
      );
    ...
    it("should search doctors with filters", async () => {
      ...
      expect(searchService.searchDoctors).toHaveBeenCalledWith(
        "Cardiology",
        "New York",
        1,
        10
    ...
    it("should return error on failure", async () => {
      vi.mocked(searchService.searchDoctors).mockRejectedValue(
        new Error("DB Error")
      );
  ...
  describe("getAllDoctors", () => {
    it("should get all doctors with default pagination", async () => {
      ...
      vi.mocked(searchService.getAllDoctors).mockResolvedValue(
        searchResult as any
      );
    ...
    it("should return error on failure", async () => {
      vi.mocked(searchService.getAllDoctors).mockRejectedValue(
        new Error("DB Error")
      );
