...
describe('analytics actions', () => {
  ...
  describe('getDashboardStats', () => {
    it('should get dashboard statistics', async () => {
      ...
      vi.mocked(analyticsService.getDashboardStats).mockResolvedValue([mockStats] as any)

      const result = await getDashboardStats()

      expect(result.success).toBe(true)
      expect(result.data).toEqual(mockStats)
      expect(analyticsService.getDashboardStats).toHaveBeenCalledWith('doctor-123')
    })
  ...
  describe('getRecentActivities', () => {
    it('should get recent activities', async () => {
      ...
      vi.mocked(analyticsService.getRecentActivities).mockResolvedValue(activities as any)
  ...
  describe('getUpcomingAppointments', () => {
    it('should get upcoming appointments', async () => {
      ...
      vi.mocked(analyticsService.getUpcomingAppointments).mockResolvedValue([mockAppointment] as any)
  ...
  describe('getScheduleAnalytics', () => {
    ...
    it('should get schedule analytics for specific doctor', async () => {
      ...
      expect(result.success).toBe(true)
      expect(analyticsService.getDashboardStats).toHaveBeenCalledWith('doctor-456')
    })
  ...
  describe('getPatientAnalytics', () => {
    it('should get patient analytics for current doctor', async () => {
      ...
      vi.mocked(analyticsService.getPatientAnalytics).mockResolvedValue(appointments as any)

      const result = await getPatientAnalytics()

      expect(result.success).toBe(true)
      expect(result.data).toEqual(appointments)
      expect(analyticsService.getPatientAnalytics).toHaveBeenCalledWith('doctor-123', 'month')
    })
    ...
    it('should get patient analytics for specific doctor and time range', async () => {
      ...
      expect(result.success).toBe(true)
      expect(analyticsService.getPatientAnalytics).toHaveBeenCalledWith('doctor-456', 'quarter')
    })
  ...
  describe('getRevenueAnalytics', () => {
    it('should get revenue analytics for current doctor', async () => {
      ...
      vi.mocked(analyticsService.getRevenueAnalytics).mockResolvedValue(revenueData as any)

      const result = await getRevenueAnalytics()

      expect(result.success).toBe(true)
      expect(result.data).toEqual(revenueData)
      expect(analyticsService.getRevenueAnalytics).toHaveBeenCalledWith('doctor-123', 'month')
    })
    ...
    it('should get revenue analytics for specific doctor and time range', async () => {
      ...
      expect(result.success).toBe(true)
      expect(analyticsService.getRevenueAnalytics).toHaveBeenCalledWith('doctor-456', 'year')
    })
