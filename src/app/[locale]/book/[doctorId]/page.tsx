...
export default async function BookAppointmentLocalePage({ params }: PageProps) {
  await requirePatient();
  const { doctorId } = await params; // locale not needed after getTranslations migration
          ...
          <div className="flex items-center space-x-4">
            ...
            <div>
              <h1 className="text-2xl font-bold text-gray-900">
                {t("doctorPrefix")} {doctor.name} {doctor.surname}
              </h1>
