...
export default function QuickActions() {
  ...
  const quickActionsData: QuickAction[] = [
    {
      id: "new-schedule",
      label: t("quickActionManageSchedulesLabel"),
      href: "/dashboard/doctor/schedules",
      icon: Calendar,
      color: "bg-blue-500 hover:bg-blue-600",
      description: t("quickActionManageSchedulesDesc"),
    },
    {
      id: "view-appointments",
      label: t("quickActionViewAppointmentsLabel"),
      href: "/dashboard/doctor/appointments",
      icon: Clock,
      color: "bg-green-500 hover:bg-green-600",
      description: t("quickActionViewAppointmentsDesc"),
    },
    {
      id: "view-analytics",
      label: t("quickActionAnalyticsLabel"),
    ...
    {
      id: "settings",
      label: t("quickActionSettingsLabel"),
