              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    ...
                    {clinic.address && (
                      <p className="text-blue-100 text-sm">{clinic.address}</p>
                    )}
                  </div>
                </div>
                <div className="flex items-center space-x-3">
                  <button
                    ...
                    className="bg-white/20 px-3 py-1 rounded-lg text-sm font-medium hover:bg-white/30 transition-colors flex items-center space-x-1"
                  >
            ...
            <div className="p-4 bg-gray-50">
              <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-4 min-w-0">
                {sortSchedulesByDay(clinicSchedules).map((schedule) => (
                  <div
                    key={schedule.id}
                    className="bg-white rounded-lg shadow-sm border border-gray-200 hover:shadow-md transition-all duration-200 min-w-0"
                  >
                    {/* Simple Schedule Card Header */}
                    <div className="p-4 border-b border-gray-100">
                      ...
                      <div className="flex items-center justify-between">
                        <span className="inline-flex items-center px-3 py-1 rounded-lg text-xs font-medium bg-blue-100 text-blue-700">
                          {schedule.timeSlots.length} espacios
                        </span>
                        <button
                          onClick={() => toggleScheduleExpansion(schedule.id)}
                          className="flex items-center space-x-1 text-blue-600 hover:text-blue-700 text-sm font-medium transition-colors px-2 py-1 rounded-lg hover:bg-blue-50"
                        >
                          <span>
