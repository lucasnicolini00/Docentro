...
export const doctorsService = {
  async getDoctorIdFromUserId(userId: string): Promise<string> {
    return withErrorHandling(
      ...
      { service: "doctorsService", method: "getDoctorIdFromUserId", params: { userId } }
    );
  },
  ...
  async updateDoctorProfile(
    ...
    return withErrorHandling(
      ...
      { service: "doctorsService", method: "updateDoctorProfile", params: { userId, doctorId } }
    );
  },
  ...
  async getDoctorProfile(userId: string) {
    return withErrorHandling(
      ...
      { service: "doctorsService", method: "getDoctorProfile", params: { userId } }
    );
  },
  ...
  async getDoctorImages(doctorId: string) {
    return withErrorHandling(
      ...
      { service: "doctorsService", method: "getDoctorImages", params: { doctorId } }
    );
  },
  ...
  async getDoctorDashboard(doctorId: string) {
    return withErrorHandling(
      ...
      { service: "doctorsService", method: "getDoctorDashboard", params: { doctorId } }
    );
  },
  ...
  async getDoctorPublicProfile(id: string) {
    return withErrorHandling(
      ...
      { service: "doctorsService", method: "getDoctorPublicProfile", params: { id } }
    );
  },
  ...
  async getProfileExperience(doctorId: string) {
    return withErrorHandling(
      ...
      { service: "doctorsService", method: "getProfileExperience", params: { doctorId } }
    );
  },
  ...
  async updateProfileExperience(id: string, description: string) {
    return withErrorHandling(
      ...
      { service: "doctorsService", method: "updateProfileExperience", params: { id } }
    );
  },
  ...
  async createProfileExperience(doctorId: string, description: string) {
    return withErrorHandling(
      ...
      { service: "doctorsService", method: "createProfileExperience", params: { doctorId } }
    );
  },
};
